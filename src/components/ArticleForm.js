          ...
          <h3 className="">Type d'articles</h3>
            <div className="bloc-deroulant-publier">
              <div className="drop-down-type">
                ...
                onChange={setChooseSelectCategorie}//A FAIRE
                ...
                classNamePrefix="select"
                closeMenuOnSelect={false}
                onChange={setChooseSelectSousCategorie}//A FAIRE
                ...
                classNamePrefix="select"
                closeMenuOnSelect={false}
                onChange={setChooseSelectSecteur} //A FAIRE
