        ...
        <div className='bloc-content-row'>
          ...
          <div className='bloc-article'>
            ...
            <form className='article-form'>
              ...
              <input
                placeholder='URL des liens à télécharger'
          ...
          <div className='types-articles'>
            ...
            <div className='bloc-deroulant-publier'>
              <form className='drop-down-type'>
                ...
                >
                  {selectSecteur
                    ? selectSecteur.map((secteur) => (
                        <option key={secteur.id_secteur}>
                          {secteur.nom_secteur}
                        </option>
                      ))
                    : ''}
                ...
                >
                  {selectCategorie
                    ? selectCategorie.map((categorie) => (
                        <option key={categorie.id_categorie}>
                ...
                <select
                  ...
                  className='list-deroulante'
                  ref={articleScat}
                  onChange={handleChangeScat}
                >
                  {selectSousCategorie
                    ? selectSousCategorie.map((sousCategorie) => (
                        <option key={sousCategorie.id_sous_categorie}>
