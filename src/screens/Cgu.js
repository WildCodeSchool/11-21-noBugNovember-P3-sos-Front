    ...
    <>
      ...
      <div className='contentCgu'>
        ...
        <h6 className='dateCGU'>
          {' '}
          CGU Date d’entrée en vigueur : 10 novembre 2021{' '}
        </h6>
        <p>
          ...
          https://www.sosjp.org (le « Site ») et aux Services définis les droits
        ...
        <p>
          ...
          Siret : 907 803 589 00015, dont le siège social est situé 29, Avenue
          Danielle casanova – 38130 Échirolles.
        </p>
        <p>
          {' '}
          (« Nous ») Nous pouvons être contactés aux coordonnées suivantes,
          notamment pour toute réclamation : Adresse postale : 29 avenue
          Danielle Casanova 38130 Échirolles Téléphone : 06 61 87 61 44 Adresse
          email: sosjp38@gmail.com
        </p>
        ...
        <ul>
          <li> Etre une personne physique ; </li>
          <li> Avoir au moins quinze (15) ans révolus</li>
          <li>
            Si Vous avez au moins dix-huit (18) ans : avoir la pleine capacité
            juridique pour contracter au titre des présentes CGU ;
          </li>
          <li>
            {' '}
            Si Vous ne disposez pas de la pleine capacité juridique, Vous devez
            obtenir l’accord de votre représentant légal avant d’accéder au Site
            et d’utiliser les Services, ce que Vous reconnaissez et acceptez
          </li>
          <li>
            Si Vous avez entre quinze (15) ans révolus et dix-huit (18) ans:
            Vous devez obligatoirement obtenir l’accord de votre représentant
            légal avant d’accéder au Site et d’utiliser les Services, ce que
            Vous reconnaissez et acceptez. Nous pourrons Vous demander à tout
            moment, et par tout moyen que Nous jugerons utile, de Nous fournir
        ...
        <p>
          ...
          internet accessible à l'adresse suivante : www.Sosjp.org{' '}
        </p>
        <p>
          ...
          Site, accessibles sur le site internet www.Sosjp.org et transmises.{' '}
        </p>
        <p>
        ...
        <ul>
          <li>
            les accompagnants ne doit pas, sous peine de sanctions pénales,
        ...
        <p>
          ...
          espace personnel sur le site www.Sosjp.org, de signaler un contenu
          contraire aux dispositions ci-dessus. Le signalement s’effectue
          directement sur l’offre d’emploi en cliquant sur l’onglet « Contact –
          signaler ».
        </p>
        ...
        <p>
          ...
          <ul>
            ...
            <li>
              ...
              caractéristiques et contraintes, notamment techniques, des
              Services.
            </li>
            <li>
              {' '}
            ...
            <li>
              {' '}
              Vous Vous interdisez en conséquence de céder, concéder ou
              transférer tout ou partie de vos droits ou obligations au titre
        ...
        <p>
          Plus généralement Vous Vous engagez à coopérer activement avec Nous en
          vue de la bonne exécution des présentes et à Nous informer de toutes
          difficultés liées à cette exécution.<p></p> Vous êtes informé(e) et
          acceptez que la mise en œuvre des Services nécessite que Vous soyez
          connecté(e) à internet et que la qualité des Services dépend
          directement de cette connexion, dont Vous êtes seul(e) responsable.
          <p></p> Vous Vous engagez à Nous informer immédiatement de tout acte
          contraire aux CGUs dont Vous auriez connaissance.<p></p> Vous
          reconnaissez que Vous utilisez le Site et les Services à vos propres
          risques, et Vous êtes seul(e) et unique responsable de votre respect
          des dispositions de l’Article 8 des présentes, et Vous êtes seul(e) et
          unique responsable, tant à notre égard qu’à l’égard des tiers, de
          toute violation des CGU ainsi que des conséquences qui en
          résulteraient.
        </p>
        ...
        <p>
          {' '}
          (i) tous comportements de nature à interrompre, suspendre, ralentir ou
          empêcher la continuité des Services, (ii) toutes intrusions ou
          tentatives d’intrusions dans nos systèmes, (iii) tous détournements
          des ressources système du Site, (iv) toutes actions de nature à
          imposer une charge disproportionnée sur les infrastructures de ces
          derniers, (v) toutes atteintes aux mesures de sécurité et
          d’authentification, (vi) tous actes de nature à porter atteinte à nos
          droits et intérêts financiers, commerciaux ou moraux ou des
          Utilisateurs du Site, et enfin plus généralement (vii) tout manquement
          aux CGUs.
        </p>
        <h4>8.4</h4>{' '}
        <p>
        ...
        <p>
          ...
          part, Nous Nous réservons le droit de : prendre toutes mesures
          appropriées et engager toute action en justice, et/ou avertir le cas
          échéant les autorités compétentes, coopérer avec elles et leur fournir
          toutes les informations utiles à la recherche et à la répression
        ...
        <p>
          ...
          expressément. Notre responsabilité est exclusivement limitée à la
          fourniture des Services selon les modalités décrites dans les CGU, à
          l’exclusion de toute autre prestation. Vous reconnaissez et acceptez
          en outre que les Services sont fournis tels quels sans aucune garantie
        ...
        <p>
          ...
          Site pour des raisons de maintenance. De même, Nous ne saurions être
          tenu responsable des difficultés ou impossibilités momentanées d’accès
          au Site qui auraient pour origine des circonstances qui leurs sont
          extérieures, la force majeure, ou encore qui seraient dues à des
          perturbations des réseaux de télécommunication.
        </p>
        <h4>10.3 </h4>
        <p>
          Nous ne Vous garantissons pas que (i) les Services, soumis à une
          recherche constante pour en améliorer notamment la performance et le
          progrès, seront totalement exempts d’erreurs, de vices ou défauts,
          (ii) ces Services, étant standard et nullement proposés à votre seule
          intention en fonction de vos propres contraintes personnelles,
          répondront spécifiquement à vos besoins et attentes, (iii) le Site
          fonctionnera de manière ininterrompue, Nous Nous réservons la faculté
          d’interrompre momentanément l’accès au Site pour des raisons de
          maintenance, et ne pouvant en aucun cas être tenus responsables des
          perturbations ou défaillances du réseau internet ou du réseau de
          télécommunication, et plus généralement qui auraient leur origine dans
          des circonstances qui lui sont extérieures ou découlant de la force
          majeure. Nous ne pourrons en aucun cas être tenus pour responsables de
          toute conséquence qui pourrait survenir au cours, ou à l’issue, de
          rencontres ou prises de contact entre plusieurs Utilisateurs ou non
          Utilisateurs, dans le cadre de l’utilisation des Services. En
          particulier, Nous ne pouvons en aucun cas être responsables si Vous ne
          parvenez pas à obtenir le résultat souhaité en utilisant les Services.
        </p>
        <h4>10.4</h4>{' '}
        <p>
        ...
        <p>
          ...
          prendre connaissance. Nous déclarons notamment respecter toutes les
          obligations et réglementaires qui Nous incombent en matière de
          protection des données à caractère personnel visant à garantir
          notamment la sécurité et la confidentialité des données collectées et
          traitées. Nous Nous engageons notamment à effectuer toutes les
          déclarations obligatoires auprès de la Commission Nationale de
          l’Informatique et des Libertés.
        </p>
        <h4>12.2</h4>
        <p>
          Vous disposez de la faculté de pouvoir Nous demander : D’accéder aux
          données Vous concernant, De rectifier vos données, De demander
          l’effacement de vos données, Une limitation de traitement de vos
          données, et La portabilité de vos données. Pour les données
          recueillies sur la base de votre consentement (cookies et profilage),
          Vous pouvez également Nous demander de procéder au retrait de votre
          consentement à tout moment et Vous opposer au traitement de vos
          données. Vous pouvez exercer les droits susmentionnés à tout moment en
          envoyant une requête à sosjp38@gmail.com
        </p>
        ...
        <p>
          ...
          jurisprudence et les tribunaux français. La survenance d’un événement
          de force majeure suspendra dans un premier temps l’exécution des
          Services pendant une durée qui ne pourra être supérieure à trois (3)
          mois. Dans l’hypothèse où le cas de force majeure se poursuivrait
          au-delà de la période susvisée, Nous pourront résilier les CGU
          applicables, de plein droit, sans formalité judiciaire, sans préavis
          et sans droit à indemnités de quelque nature que ce soit, par l’envoi
          d’une lettre recommandée avec accusé de réception ayant effet
          immédiat.
        </p>
        ...
        <p>
          ...
          Vous pourriez accéder par l'intermédiaire du Site. Nous n’endossons
          aucune responsabilité au titre des contenus, publicités, et/ou
          services disponibles sur de tels sites et applications mobiles tiers
          dont il est rappelé qu’ils sont régis par leurs propres conditions
          d’utilisation. Nous ne sommes pas non plus responsables des
          transactions intervenues entre Vous et un quelconque annonceur,
          professionnel ou commerçant (y compris ses éventuels partenaires) vers
          lequel Vous seriez orienté(e) par l'intermédiaire du Site et ne
          saurions en aucun cas être parties à quelques litiges éventuels que ce
          soit avec ces tiers.
        </p>
        ...
        <p>
          ...
          entre les Parties. En conséquence, les données et fichiers
          informatiques stockés au sein des systèmes informatiques que Nous
          exploitons ou qui sont exploités pour notre compte dans des conditions
          raisonnables de sécurité et de fiabilité, pourront être valablement
          utilisés comme preuve dans les relations entre les Parties à
          l’occasion de l’utilisation du Site. Vous pouvez accéder à ces données
          en envoyant une demande à l’adresse suivante : sosjp38@gmail.com
        </p>
        ...
        <p>
          ...
          Vous seront opposables dès leur mise en ligne sur le Site. Si Vous
          n’acceptez pas les CGU modifiées, Vous devrez ne plus accéder au Site
          et ne plus utiliser les Services. Si Vous utiliser un des Services
          postérieurement à l’entrée en vigueur des CGU modifiées, Vous serez
          réputé(e) avoir accepté ces modifications qui Vous seront pleinement
          applicables sans réserve.
        </p>
        <h3>18. Langue</h3>
        <p>
